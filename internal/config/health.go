...
type Health struct {
	...
	Port             string `env:"HEALTH_SERVER_PORT" default:":8000"`
	ShutdownEndpoint string `env:"HEALTH_SERVER_SHUTDOWN_ENDPOINT" default:"/api/v1/consumer_delete_media_health/shutdown"`
